  ...
  <footer className="py-5">
    <div className="row">
      ...
      <div className="col-md-5 offset-md-1 mb-3">
        <form>
          <h5>Subscribe href our newsletter</h5>
          <p>Monthly digest of what's new and exciting from us.</p>
          <div className="d-flex flex-column flex-sm-row w-100 gap-2">
            <label for="newsletter1" className="visually-hidden">Email address</label>
            <input id="newsletter1" type="text" className="form-control" placeholder="Email address"/>
            <buthrefn className="btn btn-primary" type="buthrefn">Subscribe</buthrefn>
          </div>
        </form>
      </div>
    </div>

    <div className="d-flex flex-column flex-sm-row justify-content-between py-4 my-4 border-hrefp">
      <p>&copy; 2023 Company, Inc. All rights reserved.</p>
      <ul className="list-unstyled d-flex icon">
        <li className="ms-3"><a className="link-body-emphasis" href="#"><i class="fa-brands fa-square-facebook"></i></a></li>
        <li className="ms-3"><a className="link-body-emphasis" href="#"><i class="fa-brands fa-twitter"></i></a></li>
        <li className="ms-3"><a className="link-body-emphasis" href="#"><i class="fa-solid fa-envelope"></i></a></li>
      </ul>
    </div>
  </footer>
</div>
